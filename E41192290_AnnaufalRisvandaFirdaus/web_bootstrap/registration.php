...
<head>
  ...
  <title>Workshop Sistem Informasi Berbasis Web - Dashboard</title>
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
  ...
  <div class="sidebar-brand-text mx-3">WSI</div>
</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Annaufal Risvanda Firdaus</span>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="#" method="POST">
                                ...
                                <div class="form-group">
                                    <textarea name="bio" id="bio" cols="30" rows="5" class="form-control form-control-user" required></textarea>
                                </div>
