...
<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">NAMA ADMIN</th>
         ...
         <div class="box-header">
            ...
            <div class="box-body">
              <form role="form" class="form-horizontal" id="form_schedule" method="post">
                ...
                <input type="text" name="NAMA" id="NAMA" tabindex="1" class="form-control" placeholder="Aditya Setya">
                </div>
             <div class="col-lg-12">
