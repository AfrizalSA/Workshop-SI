...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url('dashboard')?>"><img src="<?php echo base_url().$this->config->config['image_toko'];?>" width="90" height="90"></img><b><?= $this->config->config['nama_toko'];?></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url('/login/login')?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="User-login" class="form-control" placeholder="Username">
