...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAaXtFjL-GmaVRwPxk2BXBDWJbsAeBgLt8'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	var $backgroundColor			= '#ffffff';						// A hex color value shown as the map background when tiles have not yet loaded as the user pans
