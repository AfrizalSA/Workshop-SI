												...
												<tr>
													...
													<td>
														<form method="POST" action="fungsi/edit/edit.php?jual=jual">
															<input type="number" name="jumlah" value="<?php echo $isi['jumlah'];?>" class="form-control"min="1" max="9999999999" requred="">
													...
													<td>
															<button type="submit" required="" class="btn btn-warning">Update</button>
														</form>
										...
										<table class="table table-stripped">
											...
											<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
												...
												<tr>
													...
													<td>Bayar  </td>
													<td><input type="number" class="form-control" min="1" max="9999999999" required="" name="bayar" value="<?php echo $bayar;?>"></td>
